export type { Scholar, ScholarStatus, RewardStatus, Achievement } from "./scholar";
...
export type { ScholarAchievement, AchievementType, AchievementStatus } from "./scholarAchievement";
