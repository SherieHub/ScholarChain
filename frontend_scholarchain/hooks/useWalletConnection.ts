...
export const useWalletConnection = () => {
    // 1. Get base wallet states
    const { wallet, connected, connecting, name, disconnect, error } = useWallet();
    
    // 2. Use the dedicated Mesh hooks (This replaces manual getLovelace calls)
    ...
    return {
        ...
        connected,
        connecting,
        address, // This will automatically be the user's address
        balance, // This will automatically be the Lovelace balance
        name,
        disconnect,
        error
    };
